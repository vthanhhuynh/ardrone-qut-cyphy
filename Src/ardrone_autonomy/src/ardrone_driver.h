...
#define HEIGHT_OFFSET 0.34
#define _DEG2RAD 0.01745331111
#define _RAD2DEG 57.2957184819
extern navdata_vel_t veldata; //enddl22
...
ros::Subscriber posecmd_vel_sub;
ros::Subscriber yawcmd_vel_sub;
  ros::Subscriber teleopcmd_vel_sub;
	ros::Subscriber cmd_vel_sub;
ros::Subscriber flattrim_sub; //enddl22
