...
//        driver_post_stages->stages_list[post_stages_index++].funcs = vp_stages_latency_estimation_funcs;
    ...
    C_RESULT navdata_custom_process(const navdata_unpacked_t * const pnd) {
		...
		veldata.x = (double) (pnd->navdata_vision_raw.vision_tx_raw);      // VISION trans. en x
	    veldata.y = (double) (pnd->navdata_vision_raw.vision_ty_raw);      // VISION trans. en y
	    veldata.z = (double) (pnd->navdata_vision_raw.vision_tz_raw);      // VISION trans. en z
